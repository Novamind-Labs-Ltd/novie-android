            ...
            if (inspectionMode) {
                ...
                Box {
                    ...
                    if (rendered) {
                        ...
                        // Figma 1625:10703：锚定预览容器右上角，视觉尺寸 28dp。
                        Image(
                            painter = painterResource(R.drawable.ic_diagram_expand),
                            contentDescription = "Open diagram full screen",
                            modifier = Modifier
                                ...
                                .clickable(
                                    ...
                                    onClickLabel = "Open diagram full screen",
                                ) {
                                    showFullscreen = true
                                },
                        )
